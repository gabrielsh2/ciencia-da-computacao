...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Suzanne M2 - GabrielHoffmann", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLES, 0, suzanneVerticesSize * 3);
		...
		for (int n = 0; n < suzanneVerticesSize; n += 3) {
...
int setupGeometry()
{
	...
	bool res = loadOBJ("suzanneTriLowPoly.obj", verticesSuzanne, uvs, normals);
	suzanneVerticesSize = verticesSuzanne.size();
	...
	glBufferData(GL_ARRAY_BUFFER, verticesSuzanne.size() * sizeof(GLfloat) * 3, &verticesSuzanne[0], GL_STATIC_DRAW);
